...
<body class="w-screen min-h-screen md:flex">
    ...
    <div class="flex items-center justify-center w-8/12 mx-auto mt-2 md:w-4/12 md:-mt-10">
        <div class="w-full mx-5 mt-10 space-y-8">
            <div>
            ...
            <form class="md:space-y-10" action="{{ route('register') }}" method="POST">
                @csrf
                <input type="text" name="name" placeholder="User Name" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                <input type="email" name="email" placeholder="Email" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                ...
                <input type="password" name="password_confirmation" placeholder="Confirm Password" class="block w-full px-3 py-2 mt-4 border border-gray-300 rounded-md shadow-sm focus:outline-none">
